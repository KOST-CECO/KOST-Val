...
package ch.kostceco.tools.tiffval.validation;

import java.io.File;

import ch.kostceco.tools.tiffval.exception.TIFFValException;
import ch.kostceco.tools.tiffval.service.MessageService;
import ch.kostceco.tools.tiffval.service.Service;
...
public interface ValidationModule extends Service
{
	...
	public boolean validate( File tiffDatei ) throws TIFFValException;
