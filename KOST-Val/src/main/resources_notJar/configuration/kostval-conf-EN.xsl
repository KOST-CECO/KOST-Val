		...
		<html>
			...
			<body>
				...
				<table >
					...
					<tr  class="captioninfom">
						<td>Specifies whether image validation (JPEG and JP2) should take place [no]:</td>
						<td>
					...
					<tr  class="captioninfom">
						<td>AListing of the allowed file formats [TXT, PDFA1, PDFA2, TIFF, JP2, JPEG, WAVE, MP3, MP4, MJ2, CSV, SIARD, WARC]:</td>
						<td>
