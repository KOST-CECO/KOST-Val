	...
	<xsl:template match="/">
		<html>
			...
			<body>
					...
					<div>
						...
						<table width="100%">
							<tr class="captionm">
								...
								<td width="38%">
									Kategorie:
									<xsl:value-of select="PDFTools/iCategory" />
								</td>
								<td width="38%">
									1. Error:
									<xsl:value-of select="PDFTools/iError" />
								</td>
							</tr>
						</table>
						<table width="100%">
							<tr class="captionm">
								...
								<td width="76%">
									Code:
									<xsl:value-of select="PDFTron/Code" />
								</td>
							</tr>
						</table>
					</div>
				...
				<h3>Während der Verwendung der dualen PDF/A-Validierung sammelt
					KOST-Val bei Uneinigkeit der Validatoren in dieser Datei
					entsprechende PDF-Diagnosedaten, die für die Verbesserung der Tools
					und des Standards hilfreich sein können.</h3>
				<h3>Wir sind Ihnen dankbar, wenn Sie diese PDF-Diagnosedatei bei
					Gelegenheit der KOST-Geschäftsstelle (kost-val@kost-ceco.ch)
					zusenden könnten.</h3>
			</body>
		</html>
	</xsl:template>
