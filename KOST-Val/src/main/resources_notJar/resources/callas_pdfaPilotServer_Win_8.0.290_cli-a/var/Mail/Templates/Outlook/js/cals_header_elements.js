...
[
	...
	"to",
	"cc",
	"bcc", // this is actually never displayed by Outlook’s print view, even if self-sent mail is exported
	"subject",
//	"_appointments", //META KEY: Add _appointments
...
var header_settings =
{
	...
	"subject":{ "mode": 2 },
	"x-envelope-to":{ "fallback":["envelope-to","delivered-to","x-pop3-rcpt","**&nbsp;"]}
};
...
var displayable_appointment_infos =
[
	"start",
	"end"
];
...
var page_size =
{
	"offsetWidth":695.52 // (210mm - 13mm - 13mm) * 3.78 px/mm
};
