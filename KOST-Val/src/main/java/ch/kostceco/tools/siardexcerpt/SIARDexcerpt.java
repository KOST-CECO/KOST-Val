...
public class SIARDexcerpt implements MessageConstants {
	...
	public static void main(String[] args) throws IOException {
		...
		if (argsLength < 4) {
			...
			System.out.println(siardexcerpt.getTextResourceServiceExc().getText(locale, EXC_ERROR_PARAMETER_USAGE));
			System.exit(1);
		}
		...
		if (javaRuntimeVersion.compareTo("1.8.0") < 0) {
			System.out.println(siardexcerpt.getTextResourceServiceExc().getText(locale, EXC_ERROR_WRONG_JRE));
			System.exit(1);
		}
