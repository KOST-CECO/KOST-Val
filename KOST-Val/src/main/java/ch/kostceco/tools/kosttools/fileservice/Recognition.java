...
public class Recognition {
	/**
	 * fuehrt eine Formaterkennung basierend auf den Formaten des KaD durch und gibt
	 * das Ergebnis als String zurueck
	 * 
	 * @param checkFile Datei, welche erkannt werden soll
	...
	public static String formatRec(File checkFile) throws InterruptedException {
		...
		String checkFileExt = "." + FilenameUtils.getExtension(checkFileName).toLowerCase();
		...
		try {
			...
			if (sb2str1.contains("00")) {
				...
				if (Magic.magicJp2(checkFile)) {
					...
					if (Util.stringInFile("ftypjp2", checkFile)) {
						...
						if (checkFileExt.equals(".jpx") || checkFileExt.equals(".jpf")) {
						...
						if (checkFileExt.equals(".mjp2") || checkFileExt.equals(".mj2")) {
						...
						if (checkFileExt.equals(".jp2") || checkFileExt.equals(".jp2") || checkFileExt.equals(".jpx")
								|| checkFileExt.equals(".jpf") || checkFileExt.equals(".jpm")) {
					...
					// haben
					if (checkFileExt.equals(".mpg") || checkFileExt.equals(".mpeg") || checkFileExt.equals(".m2v")) {
				...
				if (Magic.magicMkv(checkFile)) {
					...
					if (checkFileExt.equals(".mkv") || checkFileExt.equals(".webm")) {
				...
				if (Magic.magicXml(checkFile)) {
					...
					if (Util.string15InFile("HTML", "html", "html", "html", "html", checkFile)) {
						...
						if (checkFileExt.equals(".html") || checkFileExt.equals(".htm")) {
				...
				if (Magic.magicTiff(checkFile)) {
					...
					if (checkFileExt.equals(".tiff") || checkFileExt.equals(".tif")) {
					...
					if (checkFileExt.equals(".mp3")) {
						...
						return "MP3";
					} else if (checkFileExt.equals(".mp2") || checkFileExt.equals(".mpw")
					...
					// haben
					if (checkFileExt.equals(".ili") || checkFileExt.equals(".itf")) {
						// eindeutig als INTERLIS-Datei erkannt
						return "INTERLIS";
					} else {
						// als INTERLIS-Datei erkannt aber falsche Extension
				...
				if (Magic.magicTiff(checkFile)) {
					...
					if (Util.stringInFile("multipart", checkFile)
							&& (checkFileExt.equals(".mht") || checkFileExt.equals(".mhtml"))) {
				...
				if (Magic.magicOgg(checkFile)) {
					...
					// haben
					if (checkFileExt.equals(".ogg") || checkFileExt.equals(".oga") || checkFileExt.equals(".ogv")
				...
				if (Magic.magicZip(checkFile)) {
					...
					/*
					 * ZIP koennen riesig sein und dann geht viel Zeit verloren. Entsprechend wird
					 * hier die Dateiendung sehr schnell als Filter eingesetzt um Zeit zu sparen.
					 */
					if (checkFileExt.equals(".siard")) {
						if (Util.string15InFile("content", "header", "metadata.xml", "metadata.xml", "metadata.xml",
								checkFile)) {
				...
				if (Magic.magicJpeg(checkFile)) {
					...
					// haben
					if (checkFileExt.equals(".jpg") || checkFileExt.equals(".jpeg") || checkFileExt.equals(".jpe")) {
					...
					if (checkFileExt.equals(".mp2") || checkFileExt.equals(".mpw") || checkFileExt.equals(".mpa")) {
						// eindeutig als MP2-Datei erkannt
						return "MP2";
					} else {
						// als MP3-Datei erkannt aber falsche Extension
			...
			if (checkFileExt.equals(".txt") || checkFileExt.equals(".ans") || checkFileExt.equals(".asc")) {
				...
				return "Thumbs.db";
			} else if (checkFileExt.equals(".json") && Util.stringInFile("{", checkFile)
