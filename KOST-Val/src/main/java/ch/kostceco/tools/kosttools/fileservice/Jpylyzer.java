...
public class Jpylyzer
{
			...
			throws InterruptedException
	{
		...
		String command = "\"\"" + exeFile.getAbsolutePath() + "\" \"" + jp2File.getAbsolutePath()
	...
	/** fuehrt eine Kontrolle aller benoetigten Dateien von jpylyzer durch und gibt das Ergebnis als
	 * boolean zurueck
	 * 
	 * @param dirOfJarPath
	 *          String mit dem Pfad von wo das Programm gestartet wurde
