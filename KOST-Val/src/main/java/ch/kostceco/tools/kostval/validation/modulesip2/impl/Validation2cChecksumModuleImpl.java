 ...
 * der summe kontrollieren datei: Summe berechnen und vergleichen */
		...
		try {
			...
			for ( int s = 0; s < nodeLst.getLength(); s++ ) {
				...
				if ( pruefalgorithmus.equals( pruefalgorithmusMD5 ) ) {
					// pruefalgorithmus ist MD5 und wird auf die korrekte L�nge (=32) �berpr�ft
						...
						if ( fileInSip.exists() ) {
							try {
								...
								for ( int i = 0; i < digestBytes.length; i++ ) {
									sb.append(
											Integer.toString( (digestBytes[i] & 0xff) + 0x100, 16 ).substring( 1 ) );
								}
				...
				if ( pruefalgorithmus.equals( pruefalgorithmusSHA1 ) ) {
					// pruefalgorithmus ist SHA1 und wird auf die korrekte L�nge (=40) �berpr�ft
				...
				if ( pruefalgorithmus.equals( pruefalgorithmusSHA256 ) ) {
					// pruefalgorithmus ist SHA256 und wird auf die korrekte L�nge (=64) �berpr�ft
				...
				if ( pruefalgorithmus.equals( pruefalgorithmusSHA512 ) ) {
					// pruefalgorithmus ist SHA512 und wird auf die korrekte L�nge (=128) �berpr�ft
