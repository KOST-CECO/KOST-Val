...
public class ValidationEtransparencyModuleImpl extends ValidationModuleImpl
		implements ValidationEtransparencyModule
{
	...
	public boolean validate( File valDatei, File directoryOfLogfile )
			throws ValidationEtransparencyException
	{
		...
		if ( erkennung = true ) {
			...
			try {
				...
				getMessageService().logError(
						getTextResourceService().getText( MESSAGE_XML_MODUL_E_PDFA ) + e.getMessage() );
				return false;
			}
		}
		valid = erkennung;
