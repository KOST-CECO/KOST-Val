...
public class ValidationIaccessibleModuleImpl extends ValidationModuleImpl
		implements ValidationIaccessibleModule
{
		...
		if ( erkennung = true ) {
			...
			try {
				...
				getMessageService().logError(
						getTextResourceService().getText( MESSAGE_XML_MODUL_I_PDFA ) + e.getMessage() );
				return false;
			}
		}
		valid = erkennung;
