...
public class ValidationD2structureException extends KOSTValException {

	/** @author ??? */
	private static final long serialVersionUID = 5060094531057249403L; // tbd

	public ValidationD2structureException() {
		super();
	}

	public ValidationD2structureException(String message) {
		super(message);
	}
