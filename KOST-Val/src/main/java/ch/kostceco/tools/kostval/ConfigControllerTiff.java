...
public class ConfigControllerTiff {
	...
	@FXML
	private CheckBox checkComp1, checkComp5, checkPi0, checkPi4, checkComp2, checkComp7, checkPi1, checkPi5, checkBps1,
			checkBps8, checkMultipage, checkBps2, checkBps16, checkTiles, checkComp3, checkComp8, checkPi2, checkPi6,
			checkBps4, checkBps32, checkSize, checkComp4, checkComp32773, checkPi3, checkPi8;
	...
	@FXML
	private Label labelBps, labelComp, labelOther, labelPi, labelImage, labelMessage, labelConfig;
	...
	void changePi0(ActionEvent event) {
		...
		try {
			if (checkPi0.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi2.isSelected() && !checkPi3.isSelected() && !checkPi4.isSelected()
						&& !checkPi5.isSelected() && !checkPi6.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi1(ActionEvent event) {
		...
		try {
			if (checkPi1.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi0.isSelected() && !checkPi2.isSelected() && !checkPi3.isSelected() && !checkPi4.isSelected()
						&& !checkPi5.isSelected() && !checkPi6.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi2(ActionEvent event) {
		...
		try {
			if (checkPi2.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi0.isSelected() && !checkPi3.isSelected() && !checkPi4.isSelected()
						&& !checkPi5.isSelected() && !checkPi6.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi3(ActionEvent event) {
		...
		try {
			if (checkPi3.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi2.isSelected() && !checkPi0.isSelected() && !checkPi4.isSelected()
						&& !checkPi5.isSelected() && !checkPi6.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi4(ActionEvent event) {
		...
		try {
			if (checkPi4.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi2.isSelected() && !checkPi3.isSelected() && !checkPi0.isSelected()
						&& !checkPi5.isSelected() && !checkPi6.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi5(ActionEvent event) {
		...
		try {
			if (checkPi5.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi2.isSelected() && !checkPi3.isSelected() && !checkPi4.isSelected()
						&& !checkPi0.isSelected() && !checkPi6.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi6(ActionEvent event) {
		...
		try {
			if (checkPi6.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi2.isSelected() && !checkPi3.isSelected() && !checkPi4.isSelected()
						&& !checkPi5.isSelected() && !checkPi0.isSelected() && !checkPi8.isSelected()) {
					labelMessage.setText(minOne);
	...
	void changePi8(ActionEvent event) {
		...
		try {
			if (checkPi8.isSelected()) {
				...
				// abwaehlen nur moeglich wenn noch eines selected
				if (!checkPi1.isSelected() && !checkPi2.isSelected() && !checkPi3.isSelected() && !checkPi4.isSelected()
						&& !checkPi5.isSelected() && !checkPi6.isSelected() && !checkPi0.isSelected()) {
					labelMessage.setText(minOne);
