	...
	public boolean validate(File valDatei, File directoryOfLogfile, Map<String, String> configMap, Locale locale,
		...
		try {
			...
			if (!isValid) {
				...
				/*
				 * neu werden die Fehler zusammengefasst, damit nicht bei jeder neuen Version
				 * das Mapping der Pruefschritte zu den Fehlern komplett neu erstellt werden
				 * muss.
				 * 
				 ...
				 * C Bild-Validierung
				 * 
				 * � C ContiguousCodestreamBox � C - Siz = {0} {0} in the CC � C - Coc = {0} {0}
				 * in the CC � C - Rgn = {0} {0} in the CC � C - Qcd = {0} {0} in the CC � C -
				 * Qcc = {0} {0} in the CC � C - Poc = {0} {0} in the CC � C - Crg = {0} {0} in
				 * the CC � C - Com = {0} {0} in the CC � C - tile = {0} {0} in the CC � C - Soc
				 * = {0} {0} in the CC � C - Eoc = {0} {0} in the CC � C - Cod = {0} {0} in the
				 * CC
				 * 
						...
						if (textChild.getNodeType() == Node.ELEMENT_NODE) {
							if (textChild.getNodeName().equals("signatureBox")) {
								...
								for (int j = 0; j < childrenII.getLength(); j++) {
									/*
									 * � A - ImageHeaderBox � A - ColourSpecificationBox � A - BitsPerComponentBox �
									 * A - PaletteBox � A - ComponentMappingBox � A - ChannelDefinitionBox � A -
									 * ResolutionBox
									 */
								...
								for (int k = 0; k < childrenIII.getLength(); k++) {
									/*
									 * � C - Siz = {0} {0} in the CC � C - Coc = {0} {0} in the CC � C - Rgn = {0}
									 * {0} in the CC � C - Qcd = {0} {0} in the CC � C - Qcc = {0} {0} in the CC � C
									 * - Poc = {0} {0} in the CC � C - Crg = {0} {0} in the CC � C - Com = {0} {0}
									 * in the CC � C - tile = {0} {0} in the CC � C - Soc = {0} {0} in the CC � C -
									 * Eoc = {0} {0} in the CC � C - Cod = {0} {0} in the CC
									 */
				...
				if (ixmlBox >= 1) {
					...
					Logtxt.logtxt(logFile, getTextResourceService().getText(locale, MESSAGE_XML_MODUL_B_JP2)
				...
				if (icontiguousCodestreamBox >= 1) {
					...
					Logtxt.logtxt(logFile, getTextResourceService().getText(locale, MESSAGE_XML_MODUL_C_JP2)
				...
				if (iunknown >= 1) {
					...
					Logtxt.logtxt(logFile, getTextResourceService().getText(locale, MESSAGE_XML_MODUL_D_JP2)
