...
/** Initialisierung PDF-Tools Kontrolle ob ein Schl�ssel vorhanden ist (Vollversion) wenn nicht, wird
 * die eingeschr�nkte Version verwendet Da der Schl�ssel nur f�r KOST-Val verwendet werden darf,
