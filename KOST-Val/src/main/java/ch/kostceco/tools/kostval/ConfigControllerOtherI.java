...
public class ConfigControllerOtherI {

	@FXML
	private Button buttonConfigApply, buttonSvg, buttonJpm, buttonJpx;
	...
	@FXML
	private Label labelOtherI, labelConfig;
