 ...
 * kostval -->
 * 
 * Der Controller ruft die benoetigten Module zur Reparatur der PDF-Datei in der
...
public class Controllerreppdfa implements MessageConstants {
...
//	private ValidationAvalidationAiModule validationAvalidationAiModule;
	...
	public void setValidationArepPdfaModule(ValidationArepPdfaModule validationArepPdfaModule) {
		this.validationArepPdfaModule = validationArepPdfaModule;
	}
	...
	public void setValidationAinitialisationModule(ValidationAinitialisationModule validationAinitialisationModule) {
...
//		return valid;	}
	...
	public boolean executeOptional(File valDatei, File directoryOfLogfile, Map<String, String> configMap, Locale locale,
		...
		// Reparatur
		try {
			if (this.getValidationArepPdfaModule().validate(valDatei, directoryOfLogfile, configMap, locale, logFile,
