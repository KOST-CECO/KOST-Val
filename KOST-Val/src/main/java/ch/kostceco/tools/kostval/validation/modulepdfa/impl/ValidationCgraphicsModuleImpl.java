...
public class ValidationCgraphicsModuleImpl extends ValidationModuleImpl
		implements ValidationCgraphicsModule
{
	...
	public boolean validate( File valDatei, File directoryOfLogfile )
			throws ValidationCgraphicsException
	{
		...
		if ( erkennung = true ) {
			...
			try {
				...
				getMessageService().logError(
						getTextResourceService().getText( MESSAGE_XML_MODUL_C_PDFA ) + e.getMessage() );
				return false;
			}
		}
		valid = erkennung;
