...
public interface MessageConstants
{
	...
	String	MESSAGE_XML_SUMMARYDETAIL											= "val.message.xml.summarydetail";
	...
	String	MESSAGE_XML_CONFIGURATION_ERROR_NO_SIGNATURE	= "val.message.xml.configuration.error.no.signature";
	String	ERROR_XML_CANNOT_INITIALIZE_DROID							= "val.error.xml.cannot.initialize.droid";
	...
	// *************TIFF-Meldungen*************************************************************************
	// Modul A Meldungen
	String	ERROR_XML_A_INCORRECTFILEENDING								= "val.error.xml.a.incorrectfileending";
	String	ERROR_XML_A_INCORRECTFILE											= "val.error.xml.a.incorrectfile";
	String	ERROR_XML_A_ISDIRECTORY												= "val.error.xml.a.isdirectory";

	// Modul B Meldungen
	String	MESSAGE_XML_B_CANNOTWRITEJHOVEREPORT					= "val.message.xml.b.cannotwritejhovereport";
	String	MESSAGE_XML_B_JHOVEINVALID										= "val.message.xml.b.jhoveinvalid";
	String	MESSAGE_XML_B_JHOVEMESSAGE										= "val.message.xml.b.jhovemessage";
	...
	// *************SIARD-Meldungen*************************************************************************
	// Modul A Meldungen
	String	ERROR_XML_A_NOFILE														= "val.error.xml.a.nofile";
	String	ERROR_XML_A_INCORRECTFILEENDING_SIARD					= "val.error.xml.a.incorrectfileending.siard";
	...
	String	ERROR_XML_XMLLINT1_MISSING										= "val.error.xml.xmllint1.missing";
	String	ERROR_XML_XMLLINT2_MISSING										= "val.error.xml.xmllint2.missing";
	String	ERROR_XML_XMLLINT3_MISSING										= "val.error.xml.xmllint3.missing";
	String	ERROR_XML_XMLLINT4_MISSING										= "val.error.xml.xmllint4.missing";
	...
	// *************PDFA-Meldungen*************************************************************************
	// Modul A Meldungen
	String	ERROR_XML_A_PDFA_INCORRECTFILEENDING					= "val.error.xml.a.pdfa.incorrectfileending";
	String	ERROR_XML_A_PDFA_INCORRECTFILE								= "val.error.xml.a.pdfa.incorrectfile";
	String	ERROR_XML_A_PDFA_ISDIRECTORY									= "val.error.xml.a.pdfa.isdirectory";
	...
	String	ERROR_XML_A_CALLAS_SERVICEFAILED							= "val.error.xml.a.callas.servicefailed";
	...
	// *************JP2-Meldungen*************************************************************************
	// Modul A Meldungen
	String	ERROR_XML_A_JP2_INCORRECTFILEENDING						= "val.error.xml.a.jp2.incorrectfileending";
	...
	// *************JPEG-Meldungen*************************************************************************
	// Modul A Meldungen
	String	ERROR_XML_A_JPEG_INCORRECTFILEENDING					= "val.error.xml.a.jpeg.incorrectfileending";
	String	ERROR_XML_A_JPEG_INCORRECTFILE								= "val.error.xml.a.jpeg.incorrectfile";
	String	ERROR_XML_A_JPEG_ISDIRECTORY									= "val.error.xml.a.jpeg.isdirectory";
	String	ERROR_XML_A_JPEG_SERVICEFAILED								= "val.error.xml.a.jpeg.servicefailed";
	String	ERROR_XML_A_JPEG_JIIO_FAIL										= "val.error.xml.a.jpeg.jiio.fail";
	...
	String	MESSAGE_XML_CA_DROID													= "val.message.xml.ca.droid";

	// Modul 3b Meldungen
	String	MESSAGE_XML_CB_FORMAT													= "val.message.xml.cb.format";

	// Modul 3c Meldungen
	String	MESSAGE_XML_CC_INVALID												= "val.message.xml.cc.invalid";
