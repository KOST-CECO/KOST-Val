...
public class ValidationJinteractiveformsModuleImpl extends ValidationModuleImpl
		implements ValidationJinteractiveformsModule
{
	...
	public boolean validate( File valDatei, File directoryOfLogfile )
			throws ValidationJinteractiveformsException
	{
		...
		if ( erkennung = true ) {
			...
			try {
				...
				getMessageService().logError(
						getTextResourceService().getText( MESSAGE_XML_MODUL_J_PDFA ) + e.getMessage() );
				return false;
			}
		}
		valid = erkennung;
