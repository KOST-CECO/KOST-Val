...
public class ValidationFannotationsModuleImpl extends ValidationModuleImpl
		implements ValidationFannotationsModule
{
	...
	public boolean validate( File valDatei, File directoryOfLogfile )
			throws ValidationFannotationsException
	{
