...
public class ValidationAinitialisationModuleImpl extends ValidationModuleImpl implements
		ValidationAinitialisationModule
{
			...
			throws ValidationApdfvalidationException
	{
		...
		try {
			...
			if ( !PdfValidatorAPI.getLicenseIsValid() ) {
				// Keine Vollversion vorhanden -> Interne eigeschränke Version verwenden
				...
				String strLicenseKey = lk15 + lk25 + lk35 + lk45 + lk55;
