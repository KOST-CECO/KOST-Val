...
package ch.kostceco.tools.kostval.validation.modulewave.impl;
...
/**
 * a) WAVE-Erkennung mit ffprobe inkl Codecs
 * 
 * @author Rc Claire Roethlisberger, KOST-CECO
 */

public class ValidationAvalidationWaveModuleImpl extends ValidationModuleImpl
		implements ValidationAvalidationWaveModule
{
	...
	public boolean validate( File valDatei, File directoryOfLogfile,
			...
			String dirOfJarPath ) throws ValidationAwavevalidationException
	{
				...
				if ( !resultExec.equals( "OK" ) || !outputProbe.exists() ) {
					...
					if ( min ) {
						...
						Logtxt.logtxt( logFile, getTextResourceService()
								.getText( locale, MESSAGE_XML_MODUL_A_WAVE )
								+ getTextResourceService().getText( locale,
					...
					String wave = "format_name=wav";
					String waveCodec = "codec_name=pcm";
					String formatCodec = "";
					...
					while ( scanner.hasNextLine() ) {
						...
						if ( line.contains( "codec_name=" ) ) {
							...
							if ( line.startsWith( waveCodec ) ) {
								// OK
								formatCodec = formatCodec + type + "=WAV  ";
				...
				if ( isValid ) {
					...
					if ( !resultFfmpegExec.equals( "OK" )
						...
						if ( min ) {
							...
							// setzten
							Logtxt.logtxt( logFile, getTextResourceService()
									.getText( locale, MESSAGE_XML_MODUL_B_WAVE )
									+ getTextResourceService().getText( locale,
