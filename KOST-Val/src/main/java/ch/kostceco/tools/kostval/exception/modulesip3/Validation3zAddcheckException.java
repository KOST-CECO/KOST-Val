...
public class Validation3zAddcheckException extends KOSTValException {

	/** @author razm Daniel Ludin, Bedag AG @version 0.2.0 */
	private static final long serialVersionUID = -3048334452519051805L;

	public Validation3zAddcheckException() {
		super();
	}

	public Validation3zAddcheckException(String message) {
		super(message);
	}
