...
@rem ##########################################################################
@rem
@rem  validate startup script for Windows
@rem
@rem ##########################################################################
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %VALIDATE_OPTS%  -classpath "%CLASSPATH%" de.intarsys.egov.validationclient.cli.CommandLineInterfaceClient %CMD_LINE_ARGS%
...
:fail
rem Set variable VALIDATE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%VALIDATE_EXIT_CONSOLE%" exit 1
exit /b 1
