...
"MSWin32-x64-multi-thread-10.0.17763.4499" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.17763.4499) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAECANCELLED WSAEINVALIDPROVIDER WSAENOTCONN WSAESTALE WSAENETRESET
	WSAEINTR WSAENOTSOCK WSAEMSGSIZE WSAEINPROGRESS WSAEWOULDBLOCK
	WSAECONNABORTED WSAENOMORE WSAEACCES WSAENOTEMPTY WSAELOOP WSAENOBUFS
	WSAEREFUSED WSAEBADF WSAENETDOWN WSAEAFNOSUPPORT WSAEFAULT
	WSAENOPROTOOPT WSAEREMOTE WSAEPROVIDERFAILEDINIT WSAEHOSTDOWN
	WSAECONNRESET WSAEPFNOSUPPORT WSAEDESTADDRREQ WSAEISCONN
	WSAECONNREFUSED WSAETOOMANYREFS WSAEPROTOTYPE WSAEUSERS
	WSAEHOSTUNREACH WSAEADDRNOTAVAIL WSAEDQUOT WSAEPROTONOSUPPORT
	WSAESHUTDOWN WSAEINVALIDPROCTABLE WSAEALREADY WSAENAMETOOLONG
	WSAEINVAL WSAEMFILE WSAETIMEDOUT WSAEPROCLIM WSAEOPNOTSUPP
	WSAEADDRINUSE WSAESOCKTNOSUPPORT WSAEDISCON WSAENETUNREACH
    )],
);
