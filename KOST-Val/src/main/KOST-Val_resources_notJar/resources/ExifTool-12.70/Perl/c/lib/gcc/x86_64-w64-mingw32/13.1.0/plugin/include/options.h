...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 731,             /* -Wpedantic-ms-format */
  ...
  OPT_fset_stack_executable = 1637,          /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1824,      /* -fwritable-relocated-rdata */
  OPT_fxref = 1825,                          /* -fxref */
  /* OPT_fzee = 1826, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1827,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1828,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1829,                     /* -fzero-link */
  OPT_g = 1830,                              /* -g */
  OPT_gant = 1831,                           /* -gant */
  OPT_gas_loc_support = 1832,                /* -gas-loc-support */
  OPT_gas_locview_support = 1833,            /* -gas-locview-support */
  OPT_gbtf = 1834,                           /* -gbtf */
  OPT_gcoff = 1835,                          /* -gcoff */
  OPT_gcoff1 = 1836,                         /* -gcoff1 */
  OPT_gcoff2 = 1837,                         /* -gcoff2 */
  OPT_gcoff3 = 1838,                         /* -gcoff3 */
  OPT_gcolumn_info = 1839,                   /* -gcolumn-info */
  OPT_gctf = 1840,                           /* -gctf */
  OPT_gdescribe_dies = 1841,                 /* -gdescribe-dies */
  OPT_gdwarf = 1842,                         /* -gdwarf */
  OPT_gdwarf_ = 1843,                        /* -gdwarf- */
  OPT_gdwarf32 = 1844,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1845,                       /* -gdwarf64 */
  OPT_gen_decls = 1846,                      /* -gen-decls */
  OPT_ggdb = 1847,                           /* -ggdb */
  OPT_ggnu_pubnames = 1848,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1849,                   /* -gimple-stats */
  OPT_ginline_points = 1850,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1851, /* -ginternal-reset-location-views */
  OPT_gnat = 1852,                           /* -gnat */
  OPT_gnatO = 1853,                          /* -gnatO */
  OPT_gno_ = 1854,                           /* -gno- */
  OPT_gno_pubnames = 1855,                   /* -gno-pubnames */
  OPT_gpubnames = 1856,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1857,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1858,                   /* -gsplit-dwarf */
  OPT_gstabs = 1859,                         /* -gstabs */
  OPT_gstabs_ = 1860,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1861,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1862,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1863,                        /* -gtoggle */
  OPT_gvariable_location_views = 1864,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1865,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1866,                           /* -gvms */
  OPT_gxcoff = 1867,                         /* -gxcoff */
  OPT_gxcoff_ = 1868,                        /* -gxcoff+ */
  OPT_gz = 1869,                             /* -gz */
  OPT_gz_ = 1870,                            /* -gz= */
  OPT_h = 1871,                              /* -h */
  OPT_help = 1872,                           /* -help */
  OPT_idirafter = 1873,                      /* -idirafter */
  OPT_imacros = 1874,                        /* -imacros */
  OPT_imultiarch = 1875,                     /* -imultiarch */
  OPT_imultilib = 1876,                      /* -imultilib */
  OPT_include = 1877,                        /* -include */
  OPT_iplugindir_ = 1878,                    /* -iplugindir= */
  OPT_iprefix = 1879,                        /* -iprefix */
  OPT_iquote = 1880,                         /* -iquote */
  OPT_isysroot = 1881,                       /* -isysroot */
  OPT_isystem = 1882,                        /* -isystem */
  OPT_iwithprefix = 1883,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1884,              /* -iwithprefixbefore */
  OPT_k8 = 1885,                             /* -k8 */
  OPT_l = 1886,                              /* -l */
  OPT_lang_asm = 1887,                       /* -lang-asm */
  OPT_list = 1888,                           /* -list */
  OPT_m128bit_long_double = 1889,            /* -m128bit-long-double */
  OPT_m16 = 1890,                            /* -m16 */
  OPT_m32 = 1891,                            /* -m32 */
  OPT_m3dnow = 1892,                         /* -m3dnow */
  OPT_m3dnowa = 1893,                        /* -m3dnowa */
  OPT_m64 = 1894,                            /* -m64 */
  OPT_m80387 = 1895,                         /* -m80387 */
  OPT_m8bit_idiv = 1896,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1897,             /* -m96bit-long-double */
  OPT_mabi_ = 1898,                          /* -mabi= */
  OPT_mabm = 1899,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1900,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1901,                 /* -maddress-mode= */
  OPT_madx = 1902,                           /* -madx */
  OPT_maes = 1903,                           /* -maes */
  OPT_malign_data_ = 1904,                   /* -malign-data= */
  OPT_malign_double = 1905,                  /* -malign-double */
  OPT_malign_functions_ = 1906,              /* -malign-functions= */
  OPT_malign_jumps_ = 1907,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1908,                  /* -malign-loops= */
  OPT_malign_stringops = 1909,               /* -malign-stringops */
  OPT_mamx_bf16 = 1910,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1911,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1912,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1913,                      /* -mamx-int8 */
  OPT_mamx_tile = 1914,                      /* -mamx-tile */
  ...
  OPT_mdll = 1962,                           /* -mdll */
  OPT_mdump_tune_features = 1963,            /* -mdump-tune-features */
  OPT_menqcmd = 1964,                        /* -menqcmd */
  OPT_mf16c = 1965,                          /* -mf16c */
  OPT_mfancy_math_387 = 1966,                /* -mfancy-math-387 */
  OPT_mfentry = 1967,                        /* -mfentry */
  OPT_mfentry_name_ = 1968,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1969,               /* -mfentry-section= */
  OPT_mfma = 1970,                           /* -mfma */
  OPT_mfma4 = 1971,                          /* -mfma4 */
  OPT_mforce_drap = 1972,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1973,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1974,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1975,                       /* -mfpmath= */
  OPT_mfsgsbase = 1976,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1977,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1978, */              /* -mfused-madd */
  OPT_mfxsr = 1979,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1980,             /* -mgeneral-regs-only */
  OPT_mgfni = 1981,                          /* -mgfni */
  ...
  OPT_mnop_fun_dllimport = 2024,             /* -mnop-fun-dllimport */
  ...
  OPT_mpe_aligned_commons = 2033,            /* -mpe-aligned-commons */
  OPT_mpku = 2034,                           /* -mpku */
  ...
  OPT_mserialize = 2058,                     /* -mserialize */
  OPT_msgx = 2059,                           /* -msgx */
  OPT_msha = 2060,                           /* -msha */
  OPT_mshstk = 2061,                         /* -mshstk */
  OPT_mskip_rax_setup = 2062,                /* -mskip-rax-setup */
  OPT_msoft_float = 2063,                    /* -msoft-float */
  OPT_msse = 2064,                           /* -msse */
  OPT_msse2 = 2065,                          /* -msse2 */
  OPT_msse2avx = 2066,                       /* -msse2avx */
  OPT_msse3 = 2067,                          /* -msse3 */
  OPT_msse4 = 2068,                          /* -msse4 */
  OPT_msse4_1 = 2069,                        /* -msse4.1 */
  OPT_msse4_2 = 2070,                        /* -msse4.2 */
  OPT_msse4a = 2071,                         /* -msse4a */
  /* OPT_msse5 = 2072, */                    /* -msse5 */
  OPT_msseregparm = 2073,                    /* -msseregparm */
  OPT_mssse3 = 2074,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2075,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 2078, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2079,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2080,                  /* -mstackrealign */
  OPT_mstore_max_ = 2081,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2082,            /* -mstringop-strategy= */
  OPT_mstv = 2083,                           /* -mstv */
  OPT_mtbm = 2084,                           /* -mtbm */
  OPT_mthreads = 2085,                       /* -mthreads */
  ...
  OPT_municode = 2092,                       /* -municode */
  OPT_munroll_only_small_loops = 2093,       /* -munroll-only-small-loops */
  OPT_muse_libstdc_wrappers = 2094,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 2095,                          /* -mvaes */
  OPT_mveclibabi_ = 2096,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2097,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2098,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2099,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2100,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2101,                      /* -mwbnoinvd */
  OPT_mwidekl = 2102,                        /* -mwidekl */
  OPT_mwin32 = 2103,                         /* -mwin32 */
  OPT_mwindows = 2104,                       /* -mwindows */
  OPT_mx32 = 2105,                           /* -mx32 */
  OPT_mxop = 2106,                           /* -mxop */
  ...
  OPT_no_pthread = 2116,                     /* -no-pthread */
  ...
  OPT_r = 2150,                              /* -r */
  OPT_remap = 2151,                          /* -remap */
  OPT_reverse_sort = 2152,                   /* -reverse-sort */
  OPT_s = 2153,                              /* -s */
  OPT_save_temps = 2154,                     /* -save-temps */
  OPT_save_temps_ = 2155,                    /* -save-temps= */
  OPT_shared = 2156,                         /* -shared */
  OPT_shared_libgcc = 2157,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2158,               /* -shared-libphobos */
  OPT_size_sort = 2159,                      /* -size-sort */
  /* OPT_specs = 2160, */                    /* -specs */
  OPT_specs_ = 2161,                         /* -specs= */
  OPT_static = 2162,                         /* -static */
  OPT_static_libasan = 2163,                 /* -static-libasan */
  OPT_static_libgcc = 2164,                  /* -static-libgcc */
  OPT_static_libgfortran = 2165,             /* -static-libgfortran */
  OPT_static_libgm2 = 2166,                  /* -static-libgm2 */
  OPT_static_libgo = 2167,                   /* -static-libgo */
  OPT_static_libhwasan = 2168,               /* -static-libhwasan */
  OPT_static_liblsan = 2169,                 /* -static-liblsan */
  OPT_static_libmpx = 2170,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2171,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2172,               /* -static-libphobos */
  OPT_static_libquadmath = 2173,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2174,               /* -static-libstdc++ */
  OPT_static_libtsan = 2175,                 /* -static-libtsan */
  OPT_static_libubsan = 2176,                /* -static-libubsan */
  OPT_static_pie = 2177,                     /* -static-pie */
  /* OPT_std_c__03 = 2178, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2179, */                /* -std=c++0x */
  OPT_std_c__11 = 2180,                      /* -std=c++11 */
  OPT_std_c__14 = 2181,                      /* -std=c++14 */
  OPT_std_c__17 = 2182,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2183, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2184, */                /* -std=c++1z */
  OPT_std_c__20 = 2185,                      /* -std=c++20 */
  OPT_std_c__23 = 2186,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2187, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2188, */                /* -std=c++2b */
  OPT_std_c__98 = 2189,                      /* -std=c++98 */
  OPT_std_c11 = 2190,                        /* -std=c11 */
  OPT_std_c17 = 2191,                        /* -std=c17 */
  /* OPT_std_c18 = 2192, */                  /* -std=c18 */
  /* OPT_std_c1x = 2193, */                  /* -std=c1x */
  OPT_std_c2x = 2194,                        /* -std=c2x */
  /* OPT_std_c89 = 2195, */                  /* -std=c89 */
  OPT_std_c90 = 2196,                        /* -std=c90 */
  OPT_std_c99 = 2197,                        /* -std=c99 */
  /* OPT_std_c9x = 2198, */                  /* -std=c9x */
  OPT_std_f2003 = 2199,                      /* -std=f2003 */
  OPT_std_f2008 = 2200,                      /* -std=f2008 */
  OPT_std_f2008ts = 2201,                    /* -std=f2008ts */
  OPT_std_f2018 = 2202,                      /* -std=f2018 */
  OPT_std_f95 = 2203,                        /* -std=f95 */
  OPT_std_gnu = 2204,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2205, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2206, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2207,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2208,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2209,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2210, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2211, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2212,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2213,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2214, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2215, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2216,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2217,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2218,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2219, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2220, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2221,                      /* -std=gnu2x */
  ...
  OPT_std_legacy = 2233,                     /* -std=legacy */
  OPT_stdlib_ = 2234,                        /* -stdlib= */
  OPT_symbol_ = 2235,                        /* -symbol= */
  OPT_symbolic = 2236,                       /* -symbolic */
  OPT_t = 2237,                              /* -t */
  OPT_time = 2238,                           /* -time */
  OPT_time_ = 2239,                          /* -time= */
  OPT_traditional = 2240,                    /* -traditional */
  OPT_traditional_cpp = 2241,                /* -traditional-cpp */
  OPT_tree_stats = 2242,                     /* -tree-stats */
  OPT_trigraphs = 2243,                      /* -trigraphs */
