...
#define CONFIGURE_ARGS " '--host=x86_64-w64-mingw32' '--build=x86_64-w64-mingw32' '--prefix=/z/extlib/_5034__' '--with-zlib' '--with-ldap' '--with-openssl' '--with-includes=/z/extlib/_5034__/include' '--with-libraries=/z/extlib/_5034__/lib' 'build_alias=x86_64-w64-mingw32' 'host_alias=x86_64-w64-mingw32' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/z/extlib/_5034__/lib/pkgconfig/'"
...
#define PG_VERSION_STR "PostgreSQL 15.1 on x86_64-w64-mingw32, compiled by x86_64-w64-mingw32-gcc.exe (MinGW-W64 x86_64-msvcrt-posix-seh, built by Brecht Sanders) 13.1.0, 64-bit"
