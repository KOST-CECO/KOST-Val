		...
		<html>
			...
			<body>
				<table>
					...
					<tr class="captioninfom">
						<td>- Convalida (ricercabilità ed estraibilità) con PDF Tools [tolerant]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/pdfafontpt" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>Convalida PDF/A con veraPDF [yes]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/verapdf" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- veraPDF anche errori dettagliati in inglese [yes]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Richiesta di estensioni file errate [Error]:</td>
						<td>
							<xsl:value-of select="configuration/siard/lobExtension" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>Osservazioni sui formati di file non accettati [Error]:</td>
						<td>
							<xsl:value-of select="configuration/siard/lobAzepted" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>Creare una copia SIARD riparata [no]:</td>
						<td>
							<xsl:value-of select="configuration/siard/siardrep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- salvare piccoli file LOB inline [no]:</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Riparazione dei dati </td>
						<td> </td>
					</tr>
					<tr class="captioninfom">
						<td>Creazione di ulteriori copie dei dati riparati [no]:</td>
						<td>
							<xsl:value-of select="configuration/datarep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- Migrazione da XLS a XLSX [no]:</td>
						<td>
					...
					<!-- SONSTIGES -->
					<tr class="captioninfo">
						<td>Altri formati di file accettati [EML, MBOX, WACZ, WARC, HTML, INTERLIS, DWG, IFC]:</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Nome dell'istituzione (per agenti PREMIS) [Archiv]:</td>
						<td>
