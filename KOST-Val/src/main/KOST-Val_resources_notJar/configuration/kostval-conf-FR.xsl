		...
		<html>
			...
			<body>
				<table>
					...
					<tr class="captioninfom">
						<td>- Validation (possibilité de recherche et d'extraction) avec PDF Tools [tolerant] :</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Création d'une copie réparée de PDF/A [no]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/pdfarep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- réparer les fichiers PDF/A invalides et les fichiers PDF non acceptés selon PDF/A-2u [no]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/pdfa2urep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- si la réparation est invalide selon la norme PDF/A-2u, réparer selon la norme PDF/A-2b [no]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>- corriger les extensions de fichiers LOB inexactes [no]:</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Réparation des données </td>
						<td> </td>
					</tr>
					<tr class="captioninfom">
						<td>Création de copies supplémentaires des données réparées [no] :</td>
						<td>
							<xsl:value-of select="configuration/datarep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- Migration d'un fichier XLS vers un fichier XLSX [no] :</td>
						<td>
					...
					<!-- SONSTIGES -->
					<tr class="captioninfo">
						<td>Autres formats de fichiers acceptés [EML, MBOX, WACZ, WARC, HTML, INTERLIS, DWG, IFC] :</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Reconnaître les exotiques avec DROID [yes]:</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Nom de l'institution (pour l'agent PREMIS) [Archiv]:</td>
						<td>
