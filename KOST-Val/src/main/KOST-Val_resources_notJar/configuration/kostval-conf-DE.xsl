		...
		<html>
			...
			<body>
				<table>
					...
					<tr class="captioninfom">
						<td>- Validierung (Durchsuch- und Extrahierbarkeit) mit PDF Tools [tolerant]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>- wenn Reparatur nach PDFA-2u invalide, dann nach PDF/A-2b reparieren [no]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Erlaubte SIARD Versionen [2.1, 2.2]:</td>
						<td>
							<xsl:value-of select="configuration/siard/siardversion" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>Bemängeln von nicht exakten Dateiendungen [Error]:</td>
						<td>
							<xsl:value-of select="configuration/siard/lobExtension" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>Bemängeln von nicht akzeptierent Dateiformaten [Error]:</td>
						<td>
							<xsl:value-of select="configuration/siard/lobAzepted" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>Erstellung eine reparierten SIARD-Kopie [no]:</td>
						<td>
							<xsl:value-of select="configuration/siard/siardrep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- kleine LOB-Dateien inline speichern [no]:</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Exoten mit DROID erkennen [yes]:</td>
						<td>
