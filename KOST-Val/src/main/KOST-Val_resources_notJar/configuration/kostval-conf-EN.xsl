			...
			<body>
				<table>
					...
					<tr class="captioninfom">
						...
						<td>
							<xsl:value-of select="configuration/pdfa/detailpt" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- Validation (searchability and extractability) with PDF Tools [tolerant]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/pdfafontpt" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>PDF/A validation with veraPDF [yes]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/verapdf" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- veraPDF also detailed errors in English [yes]:</td>
						<td>
							<xsl:value-of select="configuration/pdfa/detailvp" />
						</td>
					</tr>
					<tr class="captioninfom">
					...
					<tr class="captioninfom">
						<td>- if repair to PDF/A-2u is invalid, repair to PDF/A-2b [no]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Allowed SIARD versions [2.1, 2.2]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Create a repaired SIARD copy [no]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>- fill in number of rows in metadata.xml [no]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Creating Additional Copies of Repaired Data [no]:</td>
						<td>
							<xsl:value-of select="configuration/datarep" />
						</td>
					</tr>
					<tr class="captioninfom">
						<td>- Migrating from XLS to XLSX [no]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>Optional checks at dossier level:</td>
						<td></td>
					</tr>
					<tr class="captioninfom">
						<td>- Check regarding protection period [no] [^(30|110)$]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>- Check regarding public status [no] [^(Einsehbar|Nicht Einsehbar)$]:</td>
						<td>
					...
					<tr class="captioninfom">
						<td>- Check data protection [no]:</td>
						<td>
					...
					<!-- SONSTIGES -->
					<tr class="captioninfo">
						<td>Other accepted file formats [EML, MBOX, WACZ, WARC, HTML, INTERLIS, DWG, IFC]:</td>
						<td>
					...
					<tr class="captioninfo">
						<td>Name of the institution (for PREMIS Agent) [Archiv]:</td>
						<td>
